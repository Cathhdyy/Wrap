...
// Auto-detect local network IP if not in production
const DEFAULT_SIGNALING = `http://${window.location.hostname}:3001`;
const SIGNALING_SERVER = import.meta.env.VITE_SIGNALING_SERVER || DEFAULT_SIGNALING;
